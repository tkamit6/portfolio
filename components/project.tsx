...
export default function Project({
    ...
    return <motion.section ref={ref} style={{ scale: scaleYProgress, opacity: opacityProgress }} className='group  bg-gray-100 dark:bg-white/10 sm:max-w-[42rem] border-2 w-[100%] border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem] m-auto mb-3 hover:bg-white transition shadow-md sm:mb-8 -z-10 rounded-lg even:pl-10 '>
