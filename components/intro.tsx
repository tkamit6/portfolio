    ...
    return (
        <section id='home' className='max-w-[50rem] text-center scroll-mt-96 sm:mb-0'>
            ...
            <motion.div initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }} transition={{
                ...
                <Link href="#contact" className='bg-gray-900 group text-white px-7 py-2 flex items-center gap-2 rounded-full outline-none -z-10 focus:scale-110 hover:scale-110 hover:bg-gray-950 active:bg-gray-950 transition duration-300' >Contact me here <BsArrowRight className='opacity-70 group-hover:translate-x-2 transition' /> </Link>
